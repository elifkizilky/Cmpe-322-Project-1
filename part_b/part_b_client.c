...
/*
*   REFERENCES FOR PART_B:
*   Returning string from a remote server using rpcgen. Stack Overflow. (1962, April 1). 
    Retrieved December 16, 2021, from https://stackoverflow.com/questions/22165876/returning-string-from-a-remote-server-using-rpcgen 
*/
#include "part_b.h"
#include <sys/types.h>
#include <sys/stat.h>
...
part_b_prog_1(char *host, char* path1, char* path2, int input1, int input2)
{
	...
	part_b_1_arg.number1 = input1; //input 1
	part_b_1_arg.number2 = input2; //input 2
	
	result_1 = part_b_1(&part_b_1_arg, clnt); //result is coming from the server
...
main (int argc, char *argv[])
{
	...
	*/
	...
	part_b_prog_1 (host, argv[1], argv[2], input1, input2); //Start RPC
exit (0);
}
